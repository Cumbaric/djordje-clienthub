  ...
  sr: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Svaki projekat uključuje dizajn, frontend razvoj, on-page SEO osnovu, responzivan prikaz i lansiranje. Održavanje i tehnička podrška su dostupni kao posebna mesečna usluga.",
      },
      {
        q: "Da li pružate podršku nakon lansiranja?",
        a: "Da. Nudim mesečno održavanje koje pokriva ažuriranja, backup, sitne izmene sadržaja i tehničku podršku. Detalje možemo dogovoriti pre ili nakon lansiranja.",
      },
      {
        q: "Kako izgleda proces saradnje?",
        a: "Kratak briefing → arhitektura i plan → razvoj u iteracijama → review i feedback → lansiranje. Sve je transparentno i dobro organizovano od prvog koraka.",
      },
    ],
  },
  en: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Every project includes design, frontend development, on-page SEO foundations, responsive layout and deployment. Maintenance and technical support are available as a separate monthly service.",
      },
      {
        q: "Do you provide support after launch?",
        a: "Yes. I offer monthly maintenance that covers updates, backups, minor content changes and technical support. We can agree on the details before or after launch.",
      },
      {
        q: "What does the collaboration process look like?",
        a: "Short briefing → architecture and plan → iterative development → review and feedback → launch. Everything is transparent and well-organised from day one.",
      },
    ],
  },
};
